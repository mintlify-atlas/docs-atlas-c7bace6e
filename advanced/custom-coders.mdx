...
<CardGroup cols={2}>
  <Card title="MP3 Encoder" icon="music" href="/guide/extensions/mp3-encoder">
    WASM-based MP3 encoder using LAME
    
    `@mediabunny/mp3-encoder`
  </Card>
  
  <Card title="AC-3 Decoder" icon="volume" href="/guide/extensions/ac3">
...
- [Extensions](/guide/extensions/mp3-encoder) - Pre-built codec extensions
