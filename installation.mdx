...
<CardGroup cols={2}>
  ...
  <Card title="Read media files" icon="book-open" href="/guide/reading-media-files">
    Learn how to extract metadata and media data
  </Card>
  <Card title="Write media files" icon="pen" href="/guide/writing-media-files">
    Create new media files from scratch
  </Card>
  <Card title="Convert files" icon="arrows-rotate" href="/guide/converting-media-files">
